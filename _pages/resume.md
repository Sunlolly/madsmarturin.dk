...
feature_row:
  ...
  - title: "Software"
    excerpt: "Proficient at super-user level in several software suites. Examples:<br>**Microsoft Office**<br>**Jira & Confluence**<br>**Monday CRM**<br>*And many others...*<br><br>Basic proficiency in:<br>**Linux**<br>**Git**"
  - title: "Languages"
...
Implementing initial processes and followup control points for certification in - and continual adherence to - ISAE 3000 and ISAE 3402.
...
* Leading, supervising, coaching and motivating, for 15 direct reports.
* Analysing and reporting performance.
* Main point of contact for both Contact Center Management and Client.
...
IO Interactive, Copenhagen Area, Capital Region, Denmark

Shipped HITMAN 2 Live Updates and all Downloadable Content to critical acclaim with publishing partner Warner Bros.

My responsibilities includes:
* Managing the Marketing Roadmap
* Managing Sales Promotions
* Communication and coordination with team-members, production staff and management, as well as publishers, external partners, POS and other stakeholders.
...
Setting up a new office in Sweden. Assignment includes:
* Company registration
* Tax registration
* Invoicing
* Partner communication
* Floor plans, furniture and decorations
...
Two years working with indie game developers on business development.
* Project management on business-development seminars and workshops.
